<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" action="<%=request.getContextPath()%>/SearchProductosController">
        <input class="form-control me-2" name="ItemBuscar"type="search" placeholder="Buscar Titulo" aria-label="Search">
